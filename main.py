...
imie="Monika"
nazwisko="Nowakowska"
#o co chodzi #TODO 3 znak nazwiska i druga imienia ile razy wystepuje chyba

#Zadanie3 w format_ciagow.py
...
dict1 = {"key1": "napis", "key2": 12312, "key3": ["i1", "i2", "i3"]}
dict2 = {"key1": "napis", "key2": 12312, "key3": "costam"}

listaslownikow = list([dict1, dict2])
print(listaslownikow)

for i in listaslownikow:
    for z in i:
        print(i[z])